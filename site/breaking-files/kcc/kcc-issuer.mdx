...
:::info
For a detailed guide on managing Known Customer Credentials as a Wallet application, please refer to the [Known Customer Credential Guide for Wallet Apps](/issuer/kcc/kcc-wallet)
:::

## Environment Setup

If you haven't already, please follow the [Credential Issuance Server Setup Guide](/issuer/vc-serverSetup) for detailed instructions on the dependencies and packages needed to set up your server.
