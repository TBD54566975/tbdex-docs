...
All PFIs have [Offerings](/message-types#offerings) which are a menu of services they provide. Offerings describe the currency pairs and transaction parameters offered. Let's fetch all of the offerings from the PFI:
...
If you’d like to get started building an even more robust wallet, you can see our full [Wallet guide](/wallet/overview). Additionally, you can learn more about [building your own PFI](/pfi/overview), as well as [becoming a Credential Issuer](/issuer/overview) on the tbDEX network too!
