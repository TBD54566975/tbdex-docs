...
Learn how to request a [Known Customer Credential](/issuer/kcc/kcc-wallet) that your customers can use with PFIs.
:::
...
PFI Offerings contain a `requiredClaims` section that provides a definition of the credentials that must be presented as part of the [RFQ message](/wallet/send-rfq).
...
The `selectedCredentials` will be a part of the [RFQ](/wallet/send-rfq) that you create on behalf of your customer.
