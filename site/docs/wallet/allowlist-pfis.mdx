...
To determine if a PFI is part of the tbDEX network, you can check their <Web5Url to="/decentralized-identifiers/did_documents">DID document</Web5Url> for the `PFI` service type:
