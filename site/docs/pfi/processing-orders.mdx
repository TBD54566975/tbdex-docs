...
After the Wallet app receives a [Quote](/pfi/creating-quotes) from your PFI, they are able to submit an Order.
...
As a best practice, store the `Order` message in your [Exchanges database](/pfi/anatomy-of-a-pfi#main-server-entrypoint).
...
"Kotlin": "https://tbd54566975.github.io/tbdex-kt/tb-d-e-x%20-s-d-k%20-documentation/tbdex.sdk.protocol.models/-rfq/index.html"}'/> that was sent by the Wallet application.

Sensitive information such as payment details and claims are hashed and are accessible from the [privateData](https://github.com/TBD54566975/tree/main/specs/protocol#privatedata-1) section of the RFQ:
