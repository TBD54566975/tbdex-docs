...
After trust establishment, tbDEX’s standard messaging protocol enables [Participating Financial Institutions (PFIs)](/tbdex/pfi/overview) and counterparties to discover, negotiate, and confirm transactions.
...
- **[Wallet Applications:](/tbdex/wallet/overview)** These hold identifiers and credentials, acting as an agent to facilitate exchanges on behalf of a person seeking liquidity
- **[PFIs:](/tbdex/pfi/overview)** The entities offering liquidity services on a tbDEX network
- **[VC Issuers:](/tbdex/issuer/overview)** Organizations that act as sources of verifiable credentials
...
- [Onboard as PFI](/tbdex/pfi/onboarding)
- [Allowlist PFIs](/tbdex/wallet/allowlist-pfis)
- [Present Credentials](/tbdex/wallet/managing-credentials)
