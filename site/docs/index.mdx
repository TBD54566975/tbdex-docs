...
After trust establishment, tbDEX’s standard messaging protocol enables [Participating Financial Institutions (PFIs)](/pfi/overview) and counterparties to discover, negotiate, and confirm transactions.
...
- **[Wallet Applications:](/wallet/overview)** These hold identifiers and credentials, acting as an agent to facilitate exchanges on behalf of a person seeking liquidity
- **[PFIs:](/pfi/overview)** The entities offering liquidity services on a tbDEX network
- **[VC Issuers:](/issuer/overview)** Organizations that act as sources of verifiable credentials
...
- [Onboard as PFI](/pfi/onboarding)
- [Allowlist PFIs](/wallet/allowlist-pfis)
- [Present Credentials](/wallet/managing-credentials)
