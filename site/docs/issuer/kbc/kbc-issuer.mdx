...
- Specify a KBC as a required claim in an [Offering](https://developer.tbd.website/pfi/creating-offerings)
...
If you issue a KBC to a business, you'll want to specify that credential as a [required claim](/pfi/creating-offerings#required-claims) on any applicable Offerings you may provide.
