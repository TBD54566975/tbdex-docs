...
Known Business Credentials (KBC) are <Web5Url to="/verifiable-credentials/what-are-vcs">Verifiable Credentials</Web5Url> designed to streamline the Know Your Business (KYB) process for tbDEX protocol users.
...
- Specify a KBC as a required claim in an [Offering](https://developer.tbd.website/tbdex/pfi/creating-offerings)
...
In the example above, `signedKbc` is a <Web5Url to="/verifiable-credentials/jwt-to-vc#what-is-a-jwt">token</Web5Url> that you can safely provide to the business you're issuing the KBC to.

## Specify KBC as Requirement

If you issue a KBC to a business, you'll want to specify that credential as a [required claim](/tbdex/pfi/creating-offerings#required-claims) on any applicable Offerings you may provide.
