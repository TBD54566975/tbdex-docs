...
The primary function of a Credential Issuer within the tbDEX network is to bridge trust between [Wallets](/wallet/overview) and [PFIs](/pfi/overview).
...
1. [tbDEX Overview](/)
2. [Server Setup](/issuer/vc-serverSetup)
3. [Credential Issuance](/issuer/vc-issuance)
4. [Issuing a Known Customer Credential](/issuer/kcc/kcc-issuer)
5. [Issuing a Known Business Credential](/issuer/kbc/kbc-issuer)
