...
In the tbDEX ecosystem, a [Participating Financial Institution (PFI)](/tbdex/pfi/overview) provides liquidity offerings to customers via [Wallets](/tbdex/wallet/overview), allowing eligible customers to place orders and execute transactions.
...
<PfiQuickstartCodeRunner
  ...
  stepIndex={1}
  customPlaceholder={'Fetch Offerings from the PFI Endpoint'}
  viewJsonObj={true}
  collapseLevel={3}
/>
...
PFIs and Wallet applications exchange [messages](/tbdex/message-types#messages) to facilitate transactions.
...
<PfiQuickstartCodeRunner
  executeCodeName="executeGetQuote"
  stepIndex={2}
  customPlaceholder={'See the Quote'}
  viewJsonObj={true}
  collapseLevel={3}
/>
...
<PfiQuickstartCodeRunner
  executeCodeName="executeGetOrderStatus"
  stepIndex={3}
  customPlaceholder={'See the OrderStatus'}
  viewJsonObj={true}
  collapseLevel={3}
/>
...
<PfiQuickstartCodeRunner
  executeCodeName="executeGetClose"
  stepIndex={4}
  customPlaceholder={'See the Close Message'}
  viewJsonObj={true}
  collapseLevel={3}
/>
...
Congratulations on building your first PFI! To explore further, check out the full [PFI guide](/tbdex/pfi/overview).
