...
Additionally, to issue credentials, you need a <Web5Url to="/decentralized-identifiers/what-are-dids">Decentralized Identifier (DID)</Web5Url>, which will serve as your Issuer's identity.

If you don't already have one, you'll need to <Web5Url to="/decentralized-identifiers/how-to-create-did">create a DID</Web5Url> with an IDV (Identity Verification) service endpoint:
...
- [Credential Issuance Guide](/tbdex/issuer/kcc/kcc-issuer)

- [Known Customer Credential Guide](/tbdex/issuer/kcc/kcc-wallet)
