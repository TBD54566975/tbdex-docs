...
This guide introduces how to issue <Web5Url to="/verifiable-credentials/what-are-vcs">verifiable credentials (VC)</Web5Url>, a process for establishing trust between [Wallets](/docs/tbdex/wallet/overview) and [PFIs](/docs/tbdex/pfi/overview) in a tbDEX network.
