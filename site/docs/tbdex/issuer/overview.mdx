...
Credential Issuers are responsible for creating and distributing <Web5Url to="/verifiable-credentials/what-are-vcs">Verifiable Credentials (VCs)</Web5Url>, which serve as digital attestations of a party's identity or qualifications.
...
The primary function of a Credential Issuer within the tbDEX network is to bridge trust between [Wallets](/tbdex/wallet/overview) and [PFIs](/tbdex/pfi/overview).
...
2. [Server Setup](/tbdex/issuer/vc-serverSetup)
3. [Credential Issuance](/tbdex/issuer/vc-issuance)
4. [Issuing a Known Customer Credential](/tbdex/issuer/kcc/kcc-issuer)
5. [Issuing a Known Business Credential](/tbdex/issuer/kbc/kbc-issuer)
