...
As a best practice, store the `RFQ` message in your [Exchanges database](/tbdex/pfi/anatomy-of-a-pfi#main-server-entrypoint) so that both you and the Wallet app can access it.
...
Building on the example from the [Exchange API Provider section](/tbdex/pfi/anatomy-of-a-pfi#exchange-api-provider), your code might look like this:
