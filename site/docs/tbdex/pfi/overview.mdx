...
PFIs make themselves known to [Wallet applications](/docs/tbdex/wallet/overview) and engage in verifying necessary information for transaction completion with <Web5Url to="/verifiable-credentials/what-are-vcs">Verifiable Credential</Web5Url> Issuers.
