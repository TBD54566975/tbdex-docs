...
After the Wallet app receives a [Quote](/tbdex/pfi/creating-quotes) from your PFI, they are able to submit an Order.
...
As a best practice, store the `Order` message in your [Exchanges database](/tbdex/pfi/anatomy-of-a-pfi#main-server-entrypoint).
