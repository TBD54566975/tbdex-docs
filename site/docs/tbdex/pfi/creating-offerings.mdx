...
Any Wallet that has your PFI's DID will be able to query your PFI for all available Offerings, as well as fetch specific Offerings. Wallets will then use that data to make an [Request for Quote (RFQ)](/tbdex/wallet/send-rfq) to your PFI to begin a potential transaction process.
...
Once the Offering has been generated, you can store it in your database using code as shown in the [Offerings API Provider section](/tbdex/pfi/anatomy-of-a-pfi#offerings-api-provider).
