...
In the tbDEX ecosystem, a [Participating Financial Institution (PFI)](/pfi/overview) provides liquidity offerings to customers via [Wallets](/wallet/overview), allowing eligible customers to place orders and execute transactions.
...
PFIs and Wallet applications exchange [messages](/message-types#messages) to facilitate transactions.
...
Congratulations on building your first PFI! To explore further, check out the full [PFI guide](/pfi/overview).
