...
<Web5Url to="/decentralized-web-nodes/agents/"> More on Web Agents </Web5Url>

## Bearer DID

A Bearer DID is a composite type that combines a [DID](#decentralized-identifier-did), its associated [DID Document](#did-document), and a <Web5Url to="/decentralized-identifiers/key-management/"> More on Web Agents </Web5Url> containing the DID's cryptographic keys. It provides methods for signing data, verifying signatures, and managing the DID's associated keys.
...
<Web5Url to="/decentralized-identifiers/what-are-dids/">More on DWNs</Web5Url>
